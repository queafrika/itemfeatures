...
def get_items_for_stock_reco(warehouse, company):
	...
	items = frappe.db.sql(
		f"""
		select
			i.name as item_code, i.item_name, i.custom_sorting_value as sort, bin.custom_feature as custom_feature, bin.warehouse as warehouse, i.has_serial_no, i.has_batch_no, i.stock_uom
		from
		...
		where
			...
			) order by i.custom_sorting_value asc
	""",
		as_dict=1,
	)
